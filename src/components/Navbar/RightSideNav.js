...
export default function RightSideNav() {
    ...
    return (
        ...
        <div className="right-nav flex-center">
            <a href="/" className="flex-center" style={{ marginRight: '12px' }}>
                <Avatar alt="avatar" src={user} sx={{ width: 28, height: 28, marginRight: '5px' }} />
                <p style={{ fontSize: '1.17em' }}>User</p>
            </a>
            <IconButton className="right-nav-btn"><AppsIcon /></IconButton>
            <IconButton className="right-nav-btn" aria-describedby={id} onClick={handleClick}>
                <svg viewBox="0 0 28 28" alt="" className="p361ku9c" height="20" width="20">
            ...
            <IconButton className="right-nav-btn"><NotificationsIcon /></IconButton>
